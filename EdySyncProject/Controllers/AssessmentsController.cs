...
namespace EdySyncProject.Controllers
{
    ...
    public class AssessmentsController : ControllerBase
    {
        ...
        // Get analytics for an assessment (instructor only)
        ...
        public async Task<IActionResult> GetAssessmentAnalytics(Guid assessmentId)
        {
            ...
            var topStudents = results
                ...
                .Take(5)
                .Select(r => new { name = r.User.Name, score = r.Score })
                .ToList();
        ...
        // Get progress for a student (student only)
        [HttpGet("student/{userId}/progress")]
        ...
        public async Task<IActionResult> GetStudentProgress(Guid userId)
        {
            var results = await _context.Results
                ...
                .OrderBy(r => r.AttemptDate)
                .ToListAsync();

            var progress = results.Select(r => new
            {
