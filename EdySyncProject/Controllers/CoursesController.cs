...
namespace EdySyncProject.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public CoursesController(EduSyncContext context, IConfiguration config)
        {
            _context = context;
            _config = config;
        }
        ...
        public async Task<ActionResult<IEnumerable<CourseDTO>>> GetCourses()
        {
            var courses = await _context.Courses
                .Select(course => new CourseDTO
                {
                    ...
                    AttachmentName = course.AttachmentName
                })
                .ToListAsync();
        ...
        public async Task<ActionResult<CourseDTO>> PostCourse([FromForm] CreateCourseDTO dto, IFormFile file)
        {
            ...
            string attachmentUrl = null, attachmentName = null;
